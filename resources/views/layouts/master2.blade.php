...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <h3>
        <a class="nav-link" href="http://www.stg.ma/site2/blog/press" target="_blank">Actualité</a>
      </h3>
      </li>
      ...
      <li class="nav-item">
        <h3>
        <a class="nav-link" href="#objectifs" >Nos objectifs</a></h3>
      </li>
      <!-- <li class="nav-item">
        <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Disabled</a>
      </li> -->
      <li class="nav-item"><h3>
        <a class="nav-link" href="#propos" >A propos de nous   </a></h3>
      </li><li class="nav-item"><h3>
        <a class="nav-link" href="#INTRODUCTION" >Contactez nous       </a></h3>
      </li>
...
<div class="bg-info clearfix" align="center">
  <h4> <span ><!-- class="d-block p-2 bg-primary text-white" align="center" -->
